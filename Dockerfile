...
#   - Ex: docker.io/hexpm/elixir:1.18.3-erlang-27.3.4-debian-trixie-20260223-slim
#
...
# compile assets (tailwind minify + vite build + phx.digest)
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/shire ./
