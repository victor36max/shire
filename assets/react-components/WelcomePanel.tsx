...
export default function WelcomePanel({ onNewAgent, onBrowseCatalog, onMenuToggle, hasAgents }: WelcomePanelProps) {
  return (
        ...
        {hasAgents ? (
          ...
          <>
            <p className="text-muted-foreground text-center mb-8">
              Create AI agents that work together. Each agent runs in its own sandbox and can collaborate with others
              through messaging.
            </p>
