...
export default function SecretList({
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <Dialog open={formOpen} onOpenChange={(isOpen) => { if (!isOpen) handleClose(); }}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{formTitle}</DialogTitle>
            <DialogDescription>
              Secrets are encrypted at rest and available to all agents.
            </DialogDescription>
          </DialogHeader>
      ...
      <AlertDialog open={!!deleteSecret} onOpenChange={(open) => { if (!open) setDeleteSecret(null); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
